...
public class CVFragment extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        items= new ArrayList<>();
        items.add(new CVItem("8 Oct 2000",getString(R.string.lorem_text)));
        items.add(new CVItem("8 May 2000",getString(R.string.lorem_text2)));
        items.add(new CVItem("8 June 2000",getString(R.string.lorem_text)));
        items.add(new CVItem("8 July 2000",getString(R.string.lorem_text2)));
